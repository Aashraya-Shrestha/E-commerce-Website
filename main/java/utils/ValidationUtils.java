...
public class ValidationUtils {
	...
	public static boolean isTextOnly(String text) {
	    // Check if the text is null before invoking matches()
	    return text != null && text.matches("[a-zA-Z\\s]+"); // Match letters and whitespace only
	}
...
//    }
    ...
    /**
     * Validates if the provided text represents either an integer or a float.
     * 
     * @param text The text to be validated.
     * @return True if the text represents either an integer or a float, false otherwise.
     */
    public static boolean isNumeric(String number) {
        return number.matches("\\d+(\\.\\d+)?"); // Match digits with optional decimal point and more digits
    }
	...
	public static boolean isNullOrEmpty(String streetAddress) {
		// TODO Auto-generated method stub
		return false;
	}
}